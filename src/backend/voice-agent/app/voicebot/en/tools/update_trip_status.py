...
from app.voicebot.en.constants import STATUS_LABELS, ERR_CANNOT_UPDATE, ERR_NO_CURRENT_TRIP
from app.services import backend_api

logger = logging.getLogger("voice-agent.en.tools.update_trip_status")
