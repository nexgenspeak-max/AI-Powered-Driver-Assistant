...
from app.voicebot.en.constants import ERR_NO_PENDING_CANCEL, ERR_CANNOT_CANCEL, TRIP_CANCELLED
from app.services import backend_api

logger = logging.getLogger("voice-agent.en.tools.confirm_cancel_trip")
